  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved user_info as @user_info" do
        ...
        post :create, {:user_info => { "country" => "invalid value" }}, valid_session
        assigns(:user_info).should be_a_new(UserInfo)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested user_info" do
        ...
        UserInfo.any_instance.should_receive(:update).with({ "country" => "MyString" })
        put :update, {:id => user_info.to_param, :user_info => { "country" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the user_info as @user_info" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        UserInfo.any_instance.stub(:save).and_return(false)
        put :update, {:id => user_info.to_param, :user_info => { "country" => "invalid value" }}, valid_session
        assigns(:user_info).should eq(user_info)
      end
